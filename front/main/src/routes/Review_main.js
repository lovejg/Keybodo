...
const RatingWithReview = ({ totalStars = 5, initialRating = 1 }) => {
  // 5점 만점, 최소는 1점(초기값)
    ...
    <div className="rating-review-container">
      ...
      <div className="sort-buttons-container">
        ...
        <button
          ...
          className={`sort-button ${sortOrder === "highest" ? "active" : ""}`}
          style={{ marginRight: "10px" }}
        >
          별점 높은순
        </button>
        <button
          ...
          className={`sort-button ${sortOrder === "lowest" ? "active" : ""}`}
        >
          별점 낮은순
        </button>
      </div>
